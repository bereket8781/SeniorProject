...
const Login = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.socialButton} onPress={toggleFacebookModal}>
            ...
            >
                <View style={styles.modalBackground}>
                    <View style={styles.modalContainer}>
                    <Image source={require('../assets/images/faceAcc.png')} style={styles.faceIcon} />
                        <Text style={styles.modalText}>You previously logged in to EduConnect with Facebook as @acc123.</Text>
