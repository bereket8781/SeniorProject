...
const CourseDetails = ({ navigation }) => {
    ...
    const renderLessonsContent = () => (
        <View>
            <Text style = {[styles.infoLabel, { marginBottom: 12}]}>Section 1 - Introduction</Text>
            ...
            <View style = {styles.lessonItem}>
                ...
                <View style = {styles.lessonInfo}>
                    <Text style = {styles.lessonTitle}>Introduction to Design Thinking</Text>
            ...
            <Text style={[styles.infoLabel, { marginTop: 20, marginBottom: 12 }]}>Section 2 - Fundamentals</Text>
            <View style={styles.lessonItem}>
                <View style={styles.lessonNumber}>
